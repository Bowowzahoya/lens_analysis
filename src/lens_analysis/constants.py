...
FAMILIES_STRING_COLS = [
    ...
    APPLICATION_NUMBERS_COL, TITLES_COL, FIRST_ABSTRACT_COL, APPLICANTS_COL,
    OWNERS_COL, URLS_COL, DOCUMENT_TYPES_COL, CPC_CLASSIFICATIONS_COL, 
    IPCR_CLASSIFICATIONS_COL, US_CLASSIFICATIONS_COL]

FAMILIES_ORDERED_COLUMNS = [
    LENS_IDS_COL, URLS_COL,
    TITLES_COL, FIRST_ABSTRACT_COL, APPLICANTS_COL, INVENTORS_COL, OWNERS_COL,
...
APPLICANTS_FIXED_ORDERED_COLUMNS = [
    FRACTIONAL_FAMILIES_COUNT_COL, FAMILIES_COUNT_COL,
    MEAN_CITATION_SCORE_COL, MEAN_MARKET_COVERAGE_COL, MEAN_PATENT_POWER_COL,
