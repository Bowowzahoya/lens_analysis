"""
This script imports a lens export on patents dealing with invasive species 
(a niche area with inventions contributing to biodiversty solutions).
It first merges the exports to patent families, then families to applicants,
then applicants to applicant types. 
If interested in manually getting rid of aliases for a few top applicants,
uncomment the middle section.
"""
import os
import pandas as pd
from datetime import datetime

# following 5 lines not necessary if package installed on system
import sys
...
# First get patent families from the Lens export
...
# If interested in manually getting rid of aliases for the same company, uncomment:
...
# Merge families to applicants per jurisdiction
